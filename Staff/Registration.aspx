            ...
            <fieldset>
                ...
                <table width="600px">
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="txtdesignamtion" runat="server"></asp:TextBox>
                        </td>
                    ...
                    <tr>
                     <td>
                        ...
                        <td>
                            <b>
                                <asp:Label ID="lblstate" runat="server" Text="State   Name"></asp:Label></b>
                        </td>
                        <td>
                            <asp:DropDownList ID="ddlstatename" runat="server" Height="22px" Width="147px">
                        ...
                        <td>
                            <b>
                                <asp:Label ID="lbldistrictname" runat="server" Text="Ditrict Name"></asp:Label></b>
                        </td>
                        <td>
                        ...
                        <td>
                            <b>
                                <asp:Label ID="lblvillagename" runat="server" Text="Village Name"></asp:Label></b>
                        </td>
                        <td>
                            <asp:DropDownList ID="ddlvillagename" runat="server" Height="22px" Width="147px">
                        ...
                        <td>
                            <b>
                                <asp:Label ID="lbltalukaname" runat="server" Text="Taluka Name"></asp:Label></b>
                        </td>
                        <td>
                            <asp:DropDownList ID="ddltalukaname" runat="server" Height="22px" Width="147px">
